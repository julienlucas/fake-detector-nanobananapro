...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Initialize model (loaded from extension bundle, no download)
  modelStatus.style.display = 'block';
  try {
    await initModel();
    modelStatus.style.display = 'none';
  } catch (error) {
    modelStatus.querySelector('p').textContent = `Erreur: ${error.message}`;
    modelStatus.querySelector('.spinner').style.display = 'none';

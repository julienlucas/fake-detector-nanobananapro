...
ONNX_FP32_PATH = "../models/best_f191.5_acc91.5_efficientnetv2s_fake_detector_cam.onnx"
...
def prune_backbone(model, amount=0.3, method="L1"):
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("EXPORT ONNX AVEC CAM (FP32 + FP16)")
    print("=" * 60)
    ...
    # 3. Export ONNX FP32 avec CAM
    print("\n[3/6] Export ONNX FP32 avec CAM...")
